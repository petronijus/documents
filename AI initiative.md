...
**How we work**
I think there is a need to shift the way of how we work, create, generate output and sharing of work items and knowledge. 
From People with skills and tools, to People shaping data flows/streams.

illustration

**Current situation**
Example: We already changed our habit in recording calls automatically - meaning, we are transforming synchronous communication into text knowledge archive.
But what are we doing with it afterwards? We at the moment drop the ball and does not convert the archive into dataset (open format > repository > vectorization > knowledge graph > interface) and therefore we cant use it as part of Flow.

**Hypothesis: Work-flow**
I think we can split our work into couple of flows and flow types. There are *Global flows*, which every individual in the company does, and there are *Specific flow*, for different types of tasks which individuals or disciplines does.
Example of Universal Flow: Request > Discovery > Analysis > Execution > Sharing.
Ambition is to make these flows AI enabled.
...
We need crossfunctional team, which will be responsible for strategical concept, enabling new processes, democratization and training/onboarding on different way of working.

---

# Prompty

chci pripravit z toho zdroje praci, ktera by slouzila jako esej nebo vedecka prace pro novou organizaci Digitalni agentury v dobe AI. Mam k tomu uz nejaky podklady, ale je to zatim jenom zacatek a chtel bych to rozepsat a citovat nejaka jina dila nebo odkazy, ktere se zabivaji podobnym tematem.

Dal bych tam chtel integrovat nasledujici myslenky: Delim flows na Global a Specific, ale chtel bych tuhle kapitolu upravit na Global, Domain a local. Global jsou univerzalni flows, ktery jsou platny pro jakoukoliv praci